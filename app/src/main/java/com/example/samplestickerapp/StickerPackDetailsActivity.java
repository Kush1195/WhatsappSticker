...
public class StickerPackDetailsActivity extends AddStickerPackActivity {
    ...
    private void Resize()
    {
        ...
        LinearLayout.LayoutParams back_button = new LinearLayout.LayoutParams(width * 80 / 1080, height * 80 / 1920);
        back_button.setMargins(30,0,0,0);
        back.setLayoutParams(back_button);
    }
